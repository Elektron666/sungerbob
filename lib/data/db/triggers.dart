...
const statusOnlyTables = <String, List<String>>{
  'sales': ['doc_no', 'customer_id', 'doc_date', 'subtotal_net', 'vat_total', 'grand_total', 'cost_total'],
  'purchases': ['doc_no', 'supplier_id', 'doc_date', 'subtotal_net', 'vat_total', 'grand_total'],
  'sale_returns': ['doc_no', 'sale_id', 'customer_id', 'doc_date', 'grand_total', 'cost_total'],
  'purchase_returns': ['doc_no', 'purchase_id', 'supplier_id', 'doc_date', 'grand_total'],
  'collections': ['doc_no', 'customer_id', 'doc_date', 'amount', 'method'],
  'supplier_payments': ['doc_no', 'supplier_id', 'doc_date', 'amount', 'method'],
  'transfers': ['doc_no', 'from_account_id', 'to_account_id', 'amount', 'doc_date'],
  'expenses': ['doc_no', 'category_id', 'doc_date', 'amount_net', 'gross_total'],
...
List<String> statusOnlyTriggerSql(String table, List<String> frozenColumns) {
  final condition =
      frozenColumns.map((c) => 'OLD.$c IS NOT NEW.$c').join('\n   OR ');
  return [
    '''
