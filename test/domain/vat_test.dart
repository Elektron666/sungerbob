...
void main() {
  group('KDV Hariç (EXCL)', () {
    test('16,8 m³ × 3.500 → net 58.800, KDV 11.760, brüt 70.560 (Altın Senaryo 3)', () {
    ...
    test('iade satırı: 1,4 m³ × 3.500 → net 4.900, KDV 980, brüt 5.880 (adım 8)', () {
      final line = VatCalculator.excluding(
  ...
  group('KDV Dahil (INCL) — girilen tutar AYNEN korunur (Ek B)', () {
    ...
    test('1.000,00 dahil %20 → KDV 166,67 · net 833,33 · toplam TAM 1.000,00', () {
      final line = VatCalculator.includingFromGross(
    ...
    test('değişmez: her tutarda net + KDV = girilen brüt', () {
      for (final g in ['0.01', '0.99', '1', '33.33', '999.99', '123456.78']) {
        ...
        expect(line.net + line.vat, Money.parse(g), reason: 'brüt $g korunmalı');
      }
    });
  ...
  group('Kâr (her zaman KDV hariç)', () {
    test('Altın Senaryo 3: kâr 7.518,00 · marj %12,79 · maliyet üstü %14,66', () {
